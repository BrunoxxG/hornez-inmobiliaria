...
import { getPropertyById } from "@/app/lib/dataHome";
      ...
      <main className="pt-20 pb-16 bg-gray-50 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            <Link href="/" className="hover:text-hornez-red transition-colors">Inicio</Link>
            <i className="pi pi-chevron-right text-xs" />
            <Link href="/#propiedades" className="hover:text-hornez-red transition-colors">Propiedades</Link>
            <i className="pi pi-chevron-right text-xs" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <ul className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    {property.features.map(({ feature, value }) => (
                      <li key={feature.id} className="flex items-center gap-2 text-gray-600 text-sm">
                        ...
                        <span>{feature.name}{value && value !== "-" ? `: ${value}` : ""}</span>
                      </li>
                    ))}
                  </ul>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm">
                ...
                <p className="text-3xl font-bold text-hornez-red mb-5">
                ...
                <div className="grid grid-cols-3 gap-3 text-center">
                  {property.bedrooms != null && (
                    <div className="bg-gray-50 rounded-lg py-3">
                      <i className="pi pi-moon text-hornez-red block mb-1" />
                  ...
                  {property.bathrooms != null && (
                    <div className="bg-gray-50 rounded-lg py-3">
                      <i className="pi pi-wave-pulse text-hornez-red block mb-1" />
                  ...
                  {property.area != null && (
                    <div className="bg-gray-50 rounded-lg py-3">
                      <i className="pi pi-expand text-hornez-red block mb-1" />
